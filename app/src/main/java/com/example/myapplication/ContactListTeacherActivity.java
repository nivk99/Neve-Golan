...
public class ContactListTeacherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase database = FirebaseDatabase.getInstance("hhttps://neve-golan-default-rtdb.firebaseio.com/");
        ...
        Query myquery = database.getReference("users/teacher");
    ...
    public void orderByChild(String key)
    {
        ...
        Query myquery = database.getReference("users/teacher").orderByChild("key");
        myquery.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                users_teacher.clear();
    ...
    public void equalTo(String name)
    {
        ...
        Query myquery = database.getReference("users/teacher").orderByChild("_name").equalTo(name);
        myquery.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                users_teacher.clear();
